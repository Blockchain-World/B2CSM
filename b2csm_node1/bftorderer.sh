...
--name 0.orderer.b2csm \
-v $(pwd)/orderingnode_material/:/bft-config/ \
-v $(pwd)/crypto-config/ordererOrganizations/orderer.b2csm/orderers/0.orderer.b2csm/msp:/bft-config/msp \
...
bftsmart/fabric-orderingnode:amd64-1.2.0 0
