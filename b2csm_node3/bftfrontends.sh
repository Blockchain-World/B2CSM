...
--name 3000.frontend.b2csm \
-p 7050:7050 \
-v $(pwd)/frontend_material/:/bft-config/ \
-v $(pwd)/crypto-config/ordererOrganizations/frontend.b2csm/orderers/3000.frontend.b2csm/msp:/bft-config/msp \
...
bftsmart/fabric-frontend:amd64-1.2.0 3000
