        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if( returnedStatus === 40040){
                    ...
                    console.log("tableResultFormed size: " + tableResultFormed.length);
                    ...
                    console.log("tableResultFormed: " + tableResultArray);
    ...
    parseNodesInfo( async function (nodesInfo) {
        ...
        for (let i = 1; i < nodesInfo.length; i++){
            ...
            try{
                ...
                console.log("tempResult " + i + "-th: " + tempResult[0]);
            }catch (err) {
                responseNodeMap.set("NODE_IP", nodesInfo[i].IP);
                responseNodeMap.set("PUBLIC_KEY", nodesInfo[i].pubKeyJWK);
...
function visualizeGTMWQ1(gtmwQ1MaliciousAPP, middleResult) {
    ...
    let highlightNodeWithDelay = (query1Param) => {
        return new Promise(function (resolve) {
            setTimeout(function () {
                //console.log('start highlight node', query1Param[0]);
        ...
        return new Promise((resolve) => {
            setTimeout(function () {
                for (let i = 0; i < query1Round2Param[0].length; i++){
                    setTimeout(function () {
                        //console.log('start to highlight the edges: ', query1Round2Param[0][i]);
...
function gtmwQ2() {
    ...
    gtmwQ2Array[0] = "A2";
    gtmwQ2Array[1] = gtmwQ2MaliciousURL; //"google.com/"
...
function visualizeGTMWQ2(gtmwQ2MaliciousURL, potentialAPPs) {
    ...
    let highlightNodeWithDelay = (query2Param) => {
        return new Promise(function (resolve) {
            setTimeout(function () {
                //console.log('start highlight node', query2Param[0]);
    ...
    let highlightNodeWithDelay = (query3Param) => {
        return new Promise(function (resolve) {
            for (let i = 0; i < query3Param[0].length; i++){
                setTimeout(function () {
                    //console.log('start highlight node', query3Param[0][i]);
